              ...
              <div className="md:hidden grid grid-cols-1 gap-4">
                {venues.map((venue) => (
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">Location: {venue.location}</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Status: {venue.status}</p>
                  </div>
                ))}
              </div>
            </>
